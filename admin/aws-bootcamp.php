    ...
    <div class="container">
        <div class="row gy-4 justify-content-between">
            <div class="col-lg-6 order-lg-last hero-img" data-aos="zoom-out" data-aos-delay="100">
                <img src="/images/aws-bootcamp/aws.svg" class="img-fluid animated" alt="AWS Cloud">
            </div>
            <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-in">
                <h1><span>AWS</span> Cloud Bootcamp</h1>
                <p>Ready to elevate your tech career? Join our AWS Bootcamp!</p>                
                <ul>
                    <li><strong>Expert-Led Sessions 🎓</strong> – Dive deep into AWS Solutions Architect concepts.</li>
                    <li><strong>Hands-On Practice 🔧</strong> – Real-world AWS problem-solving.</li>
                    <li><strong>Certification Focused 🎯</strong> – Learn the key skills needed for AWS Certification.</li>
                    <li><strong>Career-Ready Training 👨‍💻</strong> – Master cloud technology to boost your career prospects.</li>
                </ul>
                
                <p><strong>Seize This Opportunity! 🚀</strong></p>
                <div class="d-flex">
    ...
    <div class="row gy-4">
      ...
      <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <div class="service-item d-flex">
          ...
          <div>
            <h4 class="title"><a href="#" class="stretched-link">Training and Development</a></h4>
            <p class="description">Our expert-led training programs are designed to enhance your skills and prepare you for the demands of the industry.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="200">
        <div class="service-item d-flex">
          ...
          <div>
            <h4 class="title"><a href="#" class="stretched-link">Networking Opportunities</a></h4>
            <p class="description">Connect with industry leaders and peers through our networking events, enhancing your career and building lasting relationships.</p>
          </div>
        </div>
      </div>
      <!-- Career Coaching -->
      <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="300">
        <div class="service-item d-flex">
          ...
          <div>
            <h4 class="title"><a href="#" class="stretched-link">Career Coaching</a></h4>
            <p class="description">Our dedicated career coaches support you in achieving your professional goals, ensuring you're ready to make your mark in the tech industry.</p>
          </div>
        </div>
      </div>
    </div>
...
<section id="upcoming-classes" class="upcoming-classes section mb-5">
  <div class="container">
    <div class="content-box">
      ...
      <p>🚀 Ready to elevate your career? Join Urbancode’s exclusive AWS Bootcamp, starting tomorrow! 🎯 Gain hands-on experience, master the AWS cloud, and unlock new career opportunities. Don't miss out—enroll now and be part of the future! 🌟</p>
      <p><strong>Date:</strong> October 19, 2024 <strong>Time:</strong> 11:00 AM</p>
...
<section id="upcoming-bootcamps" class="upcoming-bootcamps section">
    <div class="container">
        <h2 class="mb-5">Upcoming AWS Bootcamps</h2>
        <div class="row">
            <!-- Bootcamp Card 1 -->
            <div class="col-md-4">
                <div class="bootcamp-card">
                    <h3>AWS Essentials</h3>
                    <p>Date: Oct 13, 2024</p>
                    <p>Time: 11:00 AM</p>
                    <p>Google Meet</p>
                    <button onclick="enrollBootcamp('Oct 13, 2024 11:00:00')">Enroll Now</button>
                </div>
            </div>
            <!-- Bootcamp Card 2 -->
            <div class="col-md-4">
                <div class="bootcamp-card">
                    ...
                    <p>Time: 11:00 AM</p>
                    <p>Google Meet</p>
                    <button onclick="enrollBootcamp('Oct 20, 2024 11:00:00')">Enroll Now</button>
                </div>
            </div>
            <!-- Bootcamp Card 3 -->
            <div class="col-md-4">
                <div class="bootcamp-card">
                    <h3>AWS Architect</h3>
                    <p>Date: Oct 21, 2024</p>
                    <p>Time: 11:00 AM</p>
                    <p>Google Meet</p>
                    <button onclick="enrollBootcamp('Oct 21, 2024 11:00:00')">Enroll Now</button>
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row gy-4 justify-content-between features-item">
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <img src="images/aws-bootcamp/cloud-essentials.svg" class="img-fluid rounded" alt="Cloud Essentials">
      </div>
      <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
        <div class="content">
          <h3 class="text-uppercase">Cloud Essentials</h3>
          <ul class="subtopics">
            <li><i class="bi bi-clouds"></i> Cloud Concepts: Understanding core services and deployment models.</li>
            <li><i class="bi bi-gear"></i> AWS Core Services: Dive into EC2, S3, RDS, and more.</li>
            <li><i class="bi bi-graph-up"></i> Scaling and Elasticity: Manage traffic spikes and scale resources efficiently.</li>
            <li><i class="bi bi-shield-lock"></i> Security Basics: Implement robust security measures on AWS.</li>
          </ul>
        </div>
      </div>
    </div><!-- Features Item -->
    ...
    <div class="row gy-4 justify-content-between features-item">
      <div class="col-lg-6 d-flex align-items-center order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
        <div class="content">
          <h3 class="text-uppercase">DevOps on AWS</h3>
          <ul class="subtopics">
            <li><i class="bi bi-wrench"></i> CI/CD: Automate your software delivery process.</li>
            <li><i class="bi bi-stack"></i> Infrastructure as Code: Manage infrastructure using code.</li>
            <li><i class="bi bi-speedometer2"></i> Monitoring and Logging: Tools for performance tracking and log management.</li>
          </ul>
        </div>
      </div>
      <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
        <img src="images/aws-bootcamp/devops.svg" class="img-fluid rounded" alt="DevOps on AWS">
      </div>
    </div><!-- Features Item -->
    ...
    <div class="row gy-4 justify-content-between features-item">
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <img src="images/aws-bootcamp/architecture.svg" class="img-fluid rounded" alt="Advanced Architecting">
      </div>
      <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
        <div class="content">
          <h3 class="text-uppercase">Advanced Architecting</h3>
          <ul class="subtopics">
            <li><i class="bi bi-diagram-3"></i> Complex Architectures: Design multi-tier architecture solutions.</li>
            <li><i class="bi bi-globe"></i> High Availability: Ensure your applications are always operational.</li>
            <li><i class="bi bi-lock"></i> Enhanced Security: Advanced security techniques for protecting data and infrastructure.</li>
          </ul>
        </div>
      </div>
    </div><!-- Features Item -->
...
<section id="placement-program" class="placement-program section mb-5">
  <div class="container">
    <h2 class="text-center section-title"><span>Weekend</span> AWS Bootcamp:</h2>
    <div class="row mt-4">
      <div class="col-md-6">
          ...
          <div class="accordion-item">
            ...
            <div id="leftCollapseOne" class="accordion-collapse collapse show" aria-labelledby="leftHeadingOne" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  <li>Saturday & Sunday: Introduction to AWS, setup, and exploring EC2, S3, and RDS.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="leftHeadingTwo">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#leftCollapseTwo" aria-expanded="false" aria-controls="leftCollapseTwo">
                AWS Security & Compliance (Weekends 3-4)
              </button>
            </h2>
            <div id="leftCollapseTwo" class="accordion-collapse collapse" aria-labelledby="leftHeadingTwo" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  <li>Saturday & Sunday: Deep dive into AWS security practices, IAM, and compliance standards.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="leftHeadingThree">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#leftCollapseThree" aria-expanded="false" aria-controls="leftCollapseThree">
                DevOps on AWS (Weekends 5-6)
              </button>
            </h2>
            <div id="leftCollapseThree" class="accordion-collapse collapse" aria-labelledby="leftHeadingThree" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  <li>Saturday & Sunday: Introduction to DevOps practices on AWS including CI/CD pipelines using AWS Developer tools.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="rightHeadingOne">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rightCollapseOne" aria-expanded="false" aria-controls="rightCollapseOne">
                Advanced Networking and Architecting (Weekends 7-8)
              </button>
            </h2>
            <div id="rightCollapseOne" class="accordion-collapse collapse" aria-labelledby="rightHeadingOne" data-bs-parent="#programRight">
              <div class="accordion-body">
                <ul>
                  <li>Saturday & Sunday: Covering VPC, Direct Connect, and designing scalable architectures on AWS.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="rightHeadingTwo">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rightCollapseTwo" aria-expanded="false" aria-controls="rightCollapseTwo">
                Project Work and Certification Preparation (Weekends 9-10)
              </button>
            </h2>
            <div id="rightCollapseTwo" class="accordion-collapse collapse" aria-labelledby="rightHeadingTwo" data-bs-parent="#programRight">
              <div class="accordion-body">
                <ul>
                  <li>Saturday & Sunday: Hands-on project to apply learned skills and prepare for the AWS Certified Solutions Architect exam.</li>
                </ul>
              </div>
            </div>
          </div>
...
<section id="enroll" class="enroll section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h2>Join the AWS Bootcamp: Kickstart Your Cloud Career Today!</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" id="course" name="course" required>
                                <option selected>AWS Bootcamp</option>
            ...
            <div class="col-lg-6 text-center">
                <img src="images/aws-bootcamp/enroll.svg" alt="Enroll Image" class="img-fluid animated">
            </div>
        </div>
    </div>
</section>
...
<section id="faq" class="faq section-bg mt-5">
  <div class="container" data-aos="fade-up">
    ...
    <header class="section-header">
      <h3>FAQ</h3>
      <p>Find answers to common questions about Urbancode's AWS Bootcamp.</p>
    </header>
    ...
    <div class="faq-list">
      <ul>
        <li data-aos="fade-up" data-aos-delay="100">
          ...
          <a href="#" data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">What is the AWS Bootcamp at Urbancode?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
            <p>
              The AWS Bootcamp at Urbancode is an intensive training session designed to provide in-depth knowledge of AWS cloud services and prepare participants for AWS certification. The bootcamp covers foundational to advanced topics, tailored to enhance cloud skills efficiently.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="200">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">What does the AWS Bootcamp training include?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
            <p>
              The bootcamp includes sessions on AWS architecture, EC2, S3, RDS, VPC, and more. Participants engage in hands-on labs, real-world scenario solving, and receive insights into the AWS best practices and security principles.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="300">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Who should attend the AWS Bootcamp?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
            <p>
              The bootcamp is ideal for IT professionals, software developers, system administrators, and anyone interested in hosting highly scalable, fault-tolerant applications on the AWS platform. Both beginners and experienced professionals can benefit.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="400">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">How does this bootcamp help in AWS Certification?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
            <p>
              The bootcamp is structured to align with the AWS certification exams, providing the necessary knowledge and practical skills. It includes tips on tackling exam questions, mock tests, and a comprehensive review of the exam topics.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="500">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">How can I enroll in the AWS Bootcamp?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
            <p>
              You can enroll in the AWS Bootcamp by visiting the Urbancode website, navigating to the bootcamp section, and following the enrollment process. We recommend registering early as spots are limited and fill up quickly.
            </p>
          </div>
        </li>
      </ul>
