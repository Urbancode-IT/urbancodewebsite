    ...
    <div class="container">
        <div class="row gy-4 justify-content-between">
            <div class="col-lg-6 order-lg-last hero-img" data-aos="zoom-out" data-aos-delay="100">
                <img src="images/german-workshop/german.svg" class="img-fluid animated" alt="German Language Workshop">
            </div>
            <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-in">
                <h1><span>German </span> Workshop</h1>
                <p>Discover the intricacies of the German language in our immersive workshop!</p>
                <ul>
                    <li><strong>Expert-Led Coaching 🎓</strong> – Learn from native speakers and experienced educators.</li>
                    <li><strong>Interactive Practice 📚</strong> – Engage in live conversational practice to enhance your fluency.</li>
                    <li><strong>Grammar and Vocabulary 🎯</strong> – Master the fundamentals with targeted exercises.</li>
                    <li><strong>Instant Feedback 👂</strong> – Receive personalized feedback to refine your language skills quickly.</li>
                </ul>
                
                <p><strong>Start Your Journey to German Proficiency! 🚀</strong></p>
                <div class="d-flex">
    ...
    <div class="row gy-4">
      ...
      <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <div class="service-item d-flex">
          ...
          <div>
            <h4 class="title"><a href="#" class="stretched-link">German Language Mastery</a></h4>
            <p class="description">Immerse yourself in German culture and language through our comprehensive training covering grammar, vocabulary, and conversation skills.</p>
          </div>
        </div>
      </div>
      <!-- Personalized German Tutoring -->
      <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="200">
        <div class="service-item d-flex">
          <div class="icon flex-shrink-0"><i class="bi bi-person-check-fill"></i></div>
          <div>
            <h4 class="title"><a href="#" class="stretched-link">Personalized German Tutoring</a></h4>
            <p class="description">Get tailored German language lessons focused on your individual learning pace and objectives, enhancing both your written and spoken skills.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="300">
        <div class="service-item d-flex">
          ...
          <div>
            <h4 class="title"><a href="#" class="stretched-link">German Practice Sessions</a></h4>
            <p class="description">Engage in active German conversation practice with native speakers to boost your fluency and understand real-world language usage.</p>
          </div>
        </div>
      </div>
    </div>
...
var countDownDate = new Date("Nov 09, 2024 11:00:00").getTime();
...
<section id="upcoming-classes" class="upcoming-classes section mb-5">
  <div class="container">
    <div class="content-box">
      <h2>German Workshop</h2>

      <p><strong>Date:</strong> November 09, 2024 <strong>Time:</strong> 11:00 AM to 1:00 PM</p>
  ...
  <div class="container">
    ...
    <div class="row gy-4 justify-content-between features-item">
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <img src="images/german-workshop/grammar.svg" class="img-fluid rounded" alt="German Grammar">
      </div>
      <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
        <div class="content">
          <h3 class="text-uppercase">German Grammar</h3>
          <ul class="subtopics">
            <li><i class="bi bi-book"></i> Grammar Basics: Understand sentence structure and key grammar rules.</li>
            <li><i class="bi bi-list-check"></i> Verb Conjugation: Master essential verb forms and tenses.</li>
            <li><i class="bi bi-pencil"></i> Cases and Articles: Learn to use German cases and articles correctly.</li>
          </ul>
        </div>
      </div>
    </div><!-- Features Item -->
    ...
    <div class="row gy-4 justify-content-between features-item">
      <div class="col-lg-6 d-flex align-items-center order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
        <div class="content">
          <h3 class="text-uppercase">Conversational Practice</h3>
          <ul class="subtopics">
            <li><i class="bi bi-chat-dots"></i> Everyday Conversations: Practice common phrases and expressions.</li>
            <li><i class="bi bi-emoji-smile"></i> Pronunciation Tips: Improve your pronunciation for clear communication.</li>
            <li><i class="bi bi-people"></i> Role-Playing: Engage in real-life scenarios to build confidence.</li>
          </ul>
        </div>
      </div>
      <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
        <img src="images/german-workshop/conversation.svg" class="img-fluid rounded" alt="Conversational Practice">
      </div>
    </div><!-- Features Item -->
    ...
    <div class="row gy-4 justify-content-between features-item">
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <img src="images/german-workshop/culture.svg" class="img-fluid rounded" alt="German Culture and Context">
      </div>
      <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
        <div class="content">
          <h3 class="text-uppercase">German Culture and Context</h3>
          <ul class="subtopics">
            <li><i class="bi bi-globe"></i> Cultural Insights: Understand the cultural background of the language.</li>
            <li><i class="bi bi-map"></i> Regional Dialects: Learn about different dialects and accents in German.</li>
            <li><i class="bi bi-calendar-event"></i> Festivals and Traditions: Discover important German traditions and events.</li>
          </ul>
        </div>
      </div>
    </div><!-- Features Item -->
...
<section id="placement-program" class="placement-program section mb-5">
  <div class="container">
    <h2 class="text-center section-title"><span>One-Day</span> German Language Workshop:</h2>
    <div class="row mt-4">
      <div class="col-md-6">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="leftHeadingOne">
              <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#leftCollapseOne" aria-expanded="true" aria-controls="leftCollapseOne">
                German Grammar Basics (Morning Session)
              </button>
            </h2>
            <div id="leftCollapseOne" class="accordion-collapse collapse show" aria-labelledby="leftHeadingOne" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  <li>Introduction to basic sentence structure and grammar rules.</li>
                  <li>Understanding German noun genders and articles.</li>
                  <li>Practice with verb conjugation in present tense.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="leftHeadingTwo">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#leftCollapseTwo" aria-expanded="false" aria-controls="leftCollapseTwo">
                Vocabulary Building (Afternoon Session)
              </button>
            </h2>
            <div id="leftCollapseTwo" class="accordion-collapse collapse" aria-labelledby="leftHeadingTwo" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  <li>Learning essential vocabulary for everyday conversations.</li>
                  <li>Focus on common phrases for various situations.</li>
                  <li>Interactive activities to reinforce vocabulary retention.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="rightHeadingOne">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rightCollapseOne" aria-expanded="false" aria-controls="rightCollapseOne">
                Conversational Practice (Evening Session)
              </button>
            </h2>
            <div id="rightCollapseOne" class="accordion-collapse collapse" aria-labelledby="rightHeadingOne" data-bs-parent="#programRight">
              <div class="accordion-body">
                <ul>
                  <li>Practice common conversational scenarios with role-play.</li>
                  <li>Focus on pronunciation and fluency-building exercises.</li>
                  <li>Real-time feedback to improve speaking skills.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="rightHeadingTwo">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rightCollapseTwo" aria-expanded="false" aria-controls="rightCollapseTwo">
                German Culture & Etiquette (Final Session)
              </button>
            </h2>
            <div id="rightCollapseTwo" class="accordion-collapse collapse" aria-labelledby="rightHeadingTwo" data-bs-parent="#programRight">
              <div class="accordion-body">
                <ul>
                  <li>Introduction to German customs, traditions, and etiquette.</li>
                  <li>Understanding regional dialects and cultural differences.</li>
                  <li>Discussion on important German festivals and social norms.</li>
                </ul>
              </div>
            </div>
          </div>
...
<section id="enroll" class="enroll section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h2 class="mb-4">Enroll in the German Language Workshop</h2>
                <p>Join us for an immersive experience to kickstart your journey in learning German. Fill out the form below to secure your spot.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" id="course" name="course" required>
                                <option selected>German Language Workshop</option>
            ...
            <div class="col-lg-6 text-center">
                <img src="images/german-workshop/enroll.svg" alt="Enroll in German Workshop" class="img-fluid animated">
            </div>
        </div>
    </div>
</section>
...
<section id="faq" class="faq section-bg mt-5">
  <div class="container" data-aos="fade-up">
    ...
    <header class="section-header">
      <h3>FAQ</h3>
      <p>Find answers to common questions about our One-Day German Language Workshop.</p>
    </header>
    ...
    <div class="faq-list">
      <ul>
        <li data-aos="fade-up" data-aos-delay="100">
          ...
          <a href="#" data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">What is the One-Day German Language Workshop?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
            <p>
              Our One-Day German Language Workshop is an immersive session designed to introduce you to the basics of the German language, including grammar, vocabulary, pronunciation, and cultural insights. It’s perfect for beginners or those looking for a structured refresher.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="200">
          ...
          <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
            <p>
              You will learn essential German language skills, including basic grammar rules, common phrases, vocabulary, and pronunciation techniques. The workshop also includes interactive speaking exercises and cultural insights to enhance your understanding of German.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="300">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Who should attend this German Language Workshop?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
            <p>
              This workshop is ideal for anyone interested in learning German, from complete beginners to individuals looking for a refresher. It’s especially beneficial for travelers, students, and anyone fascinated by the German language and culture.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="400">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">How will this workshop help me learn German?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
            <p>
              The workshop offers a hands-on learning experience with interactive exercises and expert guidance. You’ll gain practical language skills and insights into German culture, giving you a strong foundation to continue learning on your own or pursue further studies.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="500">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">How can I register for the German Language Workshop?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
            <p>
              You can easily register for our German Language Workshop by visiting our website, navigating to the workshop section, and filling out the registration form. Seats are limited, so we recommend registering early to secure your spot.
            </p>
          </div>
        </li>
      </ul>
