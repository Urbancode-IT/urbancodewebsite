    ...
    <div class="container">
        <div class="row gy-4 justify-content-between">
            <div class="col-lg-6 order-lg-last hero-img" data-aos="zoom-out" data-aos-delay="100">
                <img src="images/courses/ielts-workshop/ielts.svg" class="img-fluid animated" alt="IELTS Preparation">
            </div>
            <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-in">
                <h1><span>IELTS</span> Workshop</h1>
                <p>Unlock your potential in just one day with our IELTS Workshop!</p>                
                <ul>
                    <li><strong>Expert-Led Coaching 🎓</strong> – Learn from IELTS educators with years of experience.</li>
                    <li><strong>Comprehensive Practice 📚</strong> – Tackle each section of the IELTS with tailored practice sessions.</li>
                    <li><strong>Test-Taking Strategies 🎯</strong> – Master techniques that help you excel in the actual test.</li>
                    <li><strong>Immediate Feedback 👂</strong> – Get actionable feedback to improve your performance instantly.</li>
                </ul>
                
                <p><strong>Jumpstart Your IELTS Success! 🚀</strong></p>
                <div class="d-flex">
    ...
    <div class="row gy-4">
      ...
      <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <div class="service-item d-flex">
          ...
          <div>
            <h4 class="title"><a href="#" class="stretched-link">Comprehensive IELTS Preparation</a></h4>
            <p class="description">Engage in extensive sessions covering all four IELTS components—Listening, Reading, Writing, and Speaking—to ensure your readiness for the exam.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="200">
        <div class="service-item d-flex">
          ...
          <div>
            <h4 class="title"><a href="#" class="stretched-link">Personalized Tutoring</a></h4>
            <p class="description">Receive individual attention with one-on-one tutoring sessions tailored to address your specific weaknesses and strengths in IELTS.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="300">
        <div class="service-item d-flex">
          ...
          <div>
            <h4 class="title"><a href="#" class="stretched-link">Mock Tests and Feedback</a></h4>
            <p class="description">Practice with real IELTS-like exams under timed conditions followed by detailed feedback to improve your test-taking strategies and boost confidence.</p>
          </div>
        </div>
      </div>
    </div>
...
<section id="upcoming-classes" class="upcoming-classes section mb-5">
  <div class="container">
    <div class="content-box">
      <h2>Upcoming IELTS Workshop</h2>
 
      <p><strong>Date:</strong> October 14, 2024 <strong>Time:</strong> 9:00 AM to 5:00 PM</p>
      <p><strong>Location:</strong> Live Interactive Webinar</p>
      <div class="countdown">
  ...
  <div class="container">
    ...
    <div class="row gy-4 justify-content-between features-item">
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <img src="images/courses/ielts-workshop/listening.svg" class="img-fluid rounded" alt="IELTS Listening">
      </div>
      <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
        <div class="content">
          ...
          <ul class="subtopics">
            <li><i class="bi bi-ear"></i> Listening Techniques: Strategies to enhance listening skills for better comprehension.</li>
            <li><i class="bi bi-graph-up"></i> Practice Sessions: Engage in extensive listening exercises with various accents.</li>
            <li><i class="bi bi-check2-square"></i> Real Exam Practice: Simulated exams to test your listening abilities under timed conditions.</li>
          </ul>
        </div>
      </div>
    </div><!-- Features Item -->
    ...
    <div class="row gy-4 justify-content-between features-item">
      <div class="col-lg-6 d-flex align-items-center order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
        <div class="content">
          <h3 class="text-uppercase">Reading Techniques</h3>
          <ul class="subtopics">
            <li><i class="bi bi-book-half"></i> Critical Reading: Develop skills to analyze and understand complex texts.</li>
            <li><i class="bi bi-speedometer2"></i> Speed Reading: Techniques to improve reading speed without sacrificing comprehension.</li>
            <li><i class="bi bi-puzzle"></i> Answering Strategies: Learn the best approaches for different types of questions.</li>
          </ul>
        </div>
      </div>
      <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
        <img src="images/courses/ielts-workshop/reading.svg" class="img-fluid rounded" alt="IELTS Reading">
      </div>
    </div><!-- Features Item -->
    ...
    <div class="row gy-4 justify-content-between features-item">
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <img src="images/courses/ielts-workshop/writing.svg" class="img-fluid rounded" alt="IELTS Writing">
      </div>
      <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
        <div class="content">
          <h3 class="text-uppercase">Writing Excellence</h3>
          <ul class="subtopics">
            <li><i class="bi bi-pencil"></i> Essay Structure: Master the art of essay writing with clear, coherent structures.</li>
            <li><i class="bi bi-trophy"></i> Grading Criteria: Understand the marking criteria to maximize your score.</li>
            <li><i class="bi bi-brush"></i> Personal Feedback: Receive detailed feedback on your writing to refine your techniques.</li>
          </ul>
        </div>
      </div>
    </div><!-- Features Item -->
...
<section id="placement-program" class="placement-program section mb-5">
  <div class="container">
    <h2 class="text-center section-title"><span>One-Day</span> IELTS Workshop:</h2>
    <div class="row mt-4">
      <div class="col-md-6">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="leftHeadingOne">
              <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#leftCollapseOne" aria-expanded="true" aria-controls="leftCollapseOne">
                IELTS Listening (Morning Session)
              </button>
            </h2>
            <div id="leftCollapseOne" class="accordion-collapse collapse show" aria-labelledby="leftHeadingOne" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  <li>Understanding question types and strategies for all listening sections.</li>
                  <li>Practice exercises with instant feedback.</li>
                  <li>Techniques to manage time and enhance answer accuracy.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="leftHeadingTwo">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#leftCollapseTwo" aria-expanded="false" aria-controls="leftCollapseTwo">
                IELTS Reading (Afternoon Session)
              </button>
            </h2>
            <div id="leftCollapseTwo" class="accordion-collapse collapse" aria-labelledby="leftHeadingTwo" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  <li>Techniques for quick reading and information retrieval.</li>
                  <li>Interactive reading practice with detailed reviews.</li>
                  <li>Focus on complex question types and effective answering strategies.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="rightHeadingOne">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rightCollapseOne" aria-expanded="false" aria-controls="rightCollapseOne">
                IELTS Writing (Evening Session)
              </button>
            </h2>
            <div id="rightCollapseOne" class="accordion-collapse collapse" aria-labelledby="rightHeadingOne" data-bs-parent="#programRight">
              <div class="accordion-body">
                <ul>
                  <li>Overview of IELTS writing tasks 1 and 2.</li>
                  <li>Strategies for structuring essays and reports effectively.</li>
                  <li>Live writing assessment and feedback to improve coherence and grammatical range.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="rightHeadingTwo">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rightCollapseTwo" aria-expanded="false" aria-controls="rightCollapseTwo">
                IELTS Speaking (Final Session)
              </button>
            </h2>
            <div id="rightCollapseTwo" class="accordion-collapse collapse" aria-labelledby="rightHeadingTwo" data-bs-parent="#programRight">
              <div class="accordion-body">
                <ul>
                  <li>Practical speaking exercises with peer and trainer feedback.</li>
                  <li>Mock speaking test to simulate the real exam environment.</li>
                  <li>Tips on delivering confident and clear responses.</li>
                </ul>
              </div>
            </div>
          </div>
...
<script>
  function sendEmail() {
    ...
    emailjs.send('service_io04unh', 'template_ag5reeg', params)
...
<section id="enroll" class="enroll section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h2>Enroll in Our One-Day IELTS Workshop: Achieve Mastery in IELTS Preparation!</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" id="course" name="course" required>
                                <option selected>IELTS Workshop</option>
            ...
            <div class="col-lg-6 text-center">
                <img src="images/courses/ielts-workshop/enroll.svg" alt="Enroll Image" class="img-fluid animated">
            </div>
        </div>
    </div>
</section>
...
<section id="faq" class="faq section-bg mt-5">
  <div class="container" data-aos="fade-up">
    ...
    <header class="section-header">
      <h3>FAQ</h3>
      <p>Find answers to common questions about our One-Day IELTS Workshop.</p>
    </header>
    ...
    <div class="faq-list">
      <ul>
        <li data-aos="fade-up" data-aos-delay="100">
          ...
          <a href="#" data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">What is the One-Day IELTS Workshop?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
            <p>
              Our One-Day IELTS Workshop is an intensive program designed to cover the key aspects of the IELTS test: Listening, Reading, Writing, and Speaking. It aims to boost your confidence and maximise your potential in just one day.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="200">
          ...
          <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
            <p>
              The workshop offers targeted strategies and practical exercises for each section of the IELTS exam. You'll engage in live practice sessions, receive professional feedback, and learn how to approach each type of question effectively.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="300">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Who should attend this IELTS Workshop?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
            <p>
              The workshop is perfect for anyone preparing for the IELTS exam, whether you are just starting your preparation or need a comprehensive review. It's especially useful for those looking to improve their scores or understand the test format better.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="400">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">How is this workshop beneficial for IELTS preparation?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
            <p>
              The workshop provides an immersive learning experience with immediate feedback, helping you identify and correct your weaknesses. Our expert instructors guide you through the best practices and time management techniques needed for the exam.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="500">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">How can I register for the IELTS Workshop?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
            <p>
              You can register for the IELTS Workshop by visiting our website, selecting the workshop section, and completing the registration process. We recommend signing up as early as possible, as seats are limited.
            </p>
          </div>
        </li>
      </ul>
