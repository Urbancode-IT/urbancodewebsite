  ...
  <div class="container">
    <div class="row gy-4">
      <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
        <h2>Master Full-Stack Development with React Native</h2>
        <p>Join our React Native course to master cross-platform app development for iOS and Android. Learn JavaScript, Firebase integration, and real-time project development to build high-quality mobile apps with ease.</p>       
      ...
      <div class="col-lg-6 order-1 order-lg-2 hero-img">
        <img src="images/courses/react-native/react-native.jpg" class="img-fluid" style="border-radius: 55px;" alt="React Native Course">
      </div>
    </div>
  </div>
</section>
  ...
  <nav>
    <div class="container">
      <ol class="breadcrumb">
        ...
        <li class="active" id="course-id">React Native Full-Stack Development</li>
      </ol>
    </div>
  </nav>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-7 col-xl-8 pe-lg-5">
                <header>
                    <h4 class="pb-3 text-dark">Description</h4>
                    <h5 class="pb-2">Comprehensive React Native Curriculum</h5>
                </header>
                <p class="pb-2">
            ...
            <div class="col-12 col-lg-5 col-xl-4 mt-3 mt-lg-0">
                <aside style="max-width: max-content;">
                    <h4 class="pb-3 text-center text-dark">This course includes</h4>
                    <ul class="list-unstyled m-0">
                        <li><i class="fa-regular fa-clock"></i> 50 hrs Instructor-Led Training & Hands-on Projects</li>
                        <li><i class="fa-solid fa-briefcase"></i> React Native Portfolio Development</li>
                        <li><i class="fa-solid fa-circle-info"></i> One-on-One Mentor Support</li>
                        <li><i class="fa-solid fa-award"></i> Certificate of Mastery in React Native</li>
                        <li><i class="fa-solid fa-handshake"></i> Placement Assistance for All Candidates</li>
                        <li class="text-center position-relative mt-3">
                            <button data-bs-toggle="modal" data-bs-target="#brochureModal" class="btn btn-get-started" aria-label="Get Brochure">
                                Get Brochure
                            </button>
                        </li>
                    </ul>
        ...
        <div class="accordion_inner">
            <div class="accordion-section">
                ...
                <div class="each-accordionbox">
                    <h3 class="each-title">Introduction to React Native</h3>
                    <div class="each-text">
                        <ol class="accord_ol">
                            <li>What is React Native?</li>
                            <li>Benefits of Cross-Platform Development</li>
                ...
                <div class="each-accordionbox">
                    <h3 class="each-title">JavaScript Fundamentals</h3>
                    <div class="each-text">
                        <ol class="accord_ol">
                            <li>Variables, Data Types, and Operators</li>
                            <li>Control Flow: Loops and Conditionals</li>
                            <li>Functions, Arrays, and Objects</li>
                        </ol>
                    </div>
                </div>
                <!-- React Native Basics -->
                <div class="each-accordionbox">
                    <h3 class="each-title">React Native Basics</h3>
                    <div class="each-text">
                        <ol class="accord_ol">
                ...
                <!-- React Navigation -->
                <div class="each-accordionbox">
                    <h3 class="each-title">React Navigation</h3>
                    <div class="each-text">
                        <ol class="accord_ol">
                            <li>Stack, Tab, and Drawer Navigation</li>
                            <li>Passing Params and Deep Linking</li>
                            <li>Nested Navigators</li>
                        </ol>
                    </div>
                </div>
                <!-- Firebase Integration -->
                <div class="each-accordionbox">
                    <h3 class="each-title">Firebase Integration</h3>
                    <div class="each-text">
                        <ol class="accord_ol">
                            <li>Authentication: Sign Up, Login, and Logout</li>
                            <li>Cloud Firestore Basics: Reading and Writing Data</li>
                            <li>Firebase Storage: Uploading and Retrieving Files</li>
                        </ol>
                    </div>
                </div>
                <!-- Project and Deployment -->
                <div class="each-accordionbox">
                    <h3 class="each-title">Project and Deployment</h3>
                    <div class="each-text">
                        <ol class="accord_ol">
                            <li>Building a Full-Stack Mobile Application</li>
                            <li>Deploying Apps to Google Play and App Store</li>
                            <li>Creating a Portfolio for Career Advancement</li>
                        </ol>
                    </div>
                </div>
            </div>
...
<section id="placement-program" class="placement-program section mb-5">
  <div class="container">
    <h2 class="text-center section-title"><span>1-Month</span> React Native Placement Program:</h2>
    <div class="row mt-4">
      <div class="col-md-6">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="leftHeadingOne">
              <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#leftCollapseOne" aria-expanded="true" aria-controls="leftCollapseOne">
                Fundamentals of React Native (Week 1)
              </button>
            </h2>
            <div id="leftCollapseOne" class="accordion-collapse collapse show" aria-labelledby="leftHeadingOne" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  ...
                  <li>Benefits of Cross-Platform Mobile Development</li>
                  <li>Overview of the React Native Ecosystem</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="leftHeadingTwo">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#leftCollapseTwo" aria-expanded="false" aria-controls="leftCollapseTwo">
                Setting Up the Development Environment (Week 2)
              </button>
            </h2>
            <div id="leftCollapseTwo" class="accordion-collapse collapse" aria-labelledby="leftHeadingTwo" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  <li>Installing Node.js, npm, and React Native CLI</li>
                  <li>Configuring Android Studio and Xcode</li>
                  <li>Creating Your First React Native Project</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="leftHeadingThree">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#leftCollapseThree" aria-expanded="false" aria-controls="leftCollapseThree">
                Core Components and Styling (Week 3)
              </button>
            </h2>
            <div id="leftCollapseThree" class="accordion-collapse collapse" aria-labelledby="leftHeadingThree" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  <li>Understanding Core Components: Views, Text, and Images</li>
                  <li>Handling User Inputs: Buttons and Touchable Elements</li>
                  <li>Introduction to Flexbox for Styling</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="leftHeadingFour">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#leftCollapseFour" aria-expanded="false" aria-controls="leftCollapseFour">
                Navigation and State Management (Week 4)
              </button>
            </h2>
            <div id="leftCollapseFour" class="accordion-collapse collapse" aria-labelledby="leftHeadingFour" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  <li>Using React Navigation Library</li>
                  <li>Introduction to State Management with Context API</li>
                  <li>Integrating Redux for Complex State Management</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="accordion" id="programRight">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="rightHeadingOne">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rightCollapseOne" aria-expanded="false" aria-controls="rightCollapseOne">
                APIs and Advanced Techniques (Week 5)
              </button>
            </h2>
            <div id="rightCollapseOne" class="accordion-collapse collapse" aria-labelledby="rightHeadingOne" data-bs-parent="#programRight">
              <div class="accordion-body">
                <ul>
                  <li>Fetching Data with Axios and REST APIs</li>
                  <li>Handling Offline Functionality with Local Storage</li>
          ...
          <div class="accordion-item">
            ...
            <div id="rightCollapseTwo" class="accordion-collapse collapse" aria-labelledby="rightHeadingTwo" data-bs-parent="#programRight">
              <div class="accordion-body">
                <ul>
                  <li>Building a Cross-Platform Mobile Application</li>
                  <li>Best Practices for App Deployment</li>
                  <li>Preparing Documentation and App Store Submission</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            ...
            <div id="rightCollapseThree" class="accordion-collapse collapse" aria-labelledby="rightHeadingThree" data-bs-parent="#programRight">
              <div class="accordion-body">
                <ul>
                  <li>Resume Building and Portfolio Optimization</li>
          ...
          <div class="accordion-item">
            ...
            <div id="rightCollapseFour" class="accordion-collapse collapse" aria-labelledby="rightHeadingFour" data-bs-parent="#programRight">
              <div class="accordion-body">
                <ul>
                  <li>Connecting with Recruiters in Mobile Development</li>
                  <li>Placement Drives and Career Support</li>
                  <li>Ongoing Guidance for Career Growth</li>
                </ul>
              </div>
            </div>
          </div>
...
<section id="enroll" class="enroll section">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6">
        <h2>Join Our React Native Placement Program: Kickstart Your Mobile Development Career!</h2>
        <p>Register today to embark on an exciting journey in cross-platform mobile development with React Native. Learn from industry experts, gain hands-on experience, and build real-world projects to become a skilled mobile app developer.</p>
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <select class="form-control" id="course" name="course" required>
                <option selected>React Native Placement Program</option>
                <!-- Add more specific course options if needed -->
              </select>
            </div>
          </div>
          <div class="mb-3">
            <label for="message">Message</label>
            <textarea class="form-control" id="message" name="message" rows="4" placeholder="Tell us about your interest in React Native"></textarea>
          </div>
      ...
      <div class="col-lg-6 text-center">
        <img src="images/courses/react-native/enroll.png" alt="React Native Enroll Image" class="img-fluid animated">
      </div>
    </div>
  </div>
</section>
      ...
      @media (max-width: 1200px) {
          .faq .faq-list {
           ...
           <header class="section-header">
             <h3>FAQ</h3>
             <p>Discover answers to frequently asked questions about our React Native Placement Program.</p>
             </header>
 ...
 <div class="faq-list">
  <ul>
    <li data-aos="fade-up" data-aos-delay="100">
      ...
      <a href="#" data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">What is the React Native Placement Program?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
    ...
    <li data-aos="fade-up" data-aos-delay="500">
      <i class="bi bi-question-circle icon-question"></i> 
      <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">How can I apply for the React Native Placement Program?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
