...
require_once "config.php"; ?>
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Jomhuria&family=Poppins:wght@300&display=swap');
        ...
        .hero-sec{
            background: url(./images/Video-BG.png), url(./images/video-left.png);
            background-size: 59% 100%, 44% 100%;
            background-position: top right, top left;
            background-repeat: no-repeat, no-repeat;
            background-color: #000000;
        }
        @media(max-width:1199px){
            .hero-sec{background:unset;margin: 0;padding-bottom: 0!important;}
            .hero-sec .first-half{background: url(./images/video-left.png);background-color: #000;}
            .hero-sec .second{background: url(./images/Video-BG.png);background-color: #000;}
            iframe{width: 450px;height: 300px;}
        }
        @media(max-width:600px){
            .formBox .regTag{right:30px!important;top: 62px;}
            iframe{width: 320px;height: 300px;}
	    .formBox .regTag,.formBox h2{font-size:27px;}
        }
    </style>
    <section class="hero-sec py-5">
        <div class="container" style="max-width: 1700px;">   
            <div class="row align-items-center">        
                <div class="col-12 col-xl-5 first-half py-3 py-xl-0">
                    <h2 class="login-topic pb-3 pb-xl-3 pt-3 pt-xl-0">Refer <span style="font-size:60px;color:#ffffff;">and get</span><br> Rewarded!</h2>
                    <p style="color:#ffffff;">Generate your referral code now!</p>
                    <div class="formBox level-login">
                        ...
                        <div class="box registerBox">
                            ...
                            <h2 class="regTag1" style="cursor:pointer;">LOGIN</h2>
                            <form class="form" id="registrationForm">
                                ...
                                <div class="f_row">
                                    <label>UPI ID <i class="fa-solid fa-circle-info" title="This information is required to credit the referral amount to your account"></i></label>
                                    <input type="text" class="input-field" id="upi" required title="This information is required to credit the referral amount to your account">
                                    <u></u>
                                </div>
                                <div class="f_row">
                                    <label>Password</label>
                        ...
                        <a href="#" class="regTag regTag1 icon-add">
                ...
                <div class="col-12 col-xl-7 second py-3 py-xl-0">
                    <div class="video-tab p-3 p-xl-5">
                        <!-- <video width="100%" controls class="mb-3 mb-xl-5" style="border-radius: 15px;background: #fff;">
                            <source src="mov_bbb.mp4" type="video/mp4">
                        </video> -->
                        <iframe class="mb-3 mb-xl-5" style="border-radius: 15px;background: #fff;" width="100%" height="500" src="https://www.youtube.com/embed/KgFpgxmlP0I?si=fPSy5e8Z6ZF-2qBa?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen=""></iframe>
                        <p style="color:#ffffff;">Welcome to our Referral Program - the gateway to exclusive benefits for both you and your friends! We believe that great experiences are better when shared, so we've designed a rewarding program to express our gratitude for your support.</p>
                    </div>
                </div>
            </div> 
        </div> 
    ...
    <script>
        ...
        // $('.regTag').on('click', function() {
        //     var $this = $(this);
        //     if ($this.hasClass('registered')) {
        //         $this.text('REGISTER').removeClass('registered');
        //     } else {
        //         $this.text('LOGIN').addClass('registered');
        //     }
        // });
    </script>
