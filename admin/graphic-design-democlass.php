    ...
    <div class="container">
        <div class="row gy-4 justify-content-between">
            <div class="col-lg-6 order-lg-last hero-img" data-aos="zoom-out" data-aos-delay="100">
                <img src="/images/graphic-design-demo/demo-class.png" class="img-fluid animated" alt="Graphic Design Demo Class">
            </div>
            <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-in">
                <h1><span>FREE</span> Graphic Design Demo Class</h1>
                <p>Want to explore the world of graphic design?</p>                
                <ul>
                    <li><strong>Expert Guidance 🎨</strong> – Learn from experienced graphic designers.</li>
                    <li><strong>Hands-On Training 🖌️</strong> – Work on real-world design projects.</li>
                    <li><strong>Adobe Tools Focused 📐</strong> – Get trained in Photoshop & Illustrator.</li>
                    <li><strong>Career-Oriented 🎯</strong> – Build a strong foundation in graphic design.</li>
                </ul>
                
                <p><strong>Join our exclusive FREE demo class today! 🚀</strong></p>
                <div class="d-flex">
                    <a href="#enroll" class="btn-get-started">Register Now</a>
                    <a href="#" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch</span></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row gy-4">
      ...
      <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <div class="service-item d-flex">
          ...
          <div>
            <h4 class="title"><a href="#" class="stretched-link">Hands-On Graphic Design Training</a></h4>
            <p class="description">Learn the fundamentals of Photoshop & Illustrator through interactive, practical sessions with expert designers.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="200">
        <div class="service-item d-flex">
          ...
          <div>
            <h4 class="title"><a href="#" class="stretched-link">Live Project Experience</a></h4>
            <p class="description">Work on real-world design projects and build your portfolio with industry-relevant assignments.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="300">
        <div class="service-item d-flex">
          <div class="icon flex-shrink-0"><i class="bi bi-patch-check"></i></div>
          <div>
            <h4 class="title"><a href="#" class="stretched-link">Career Guidance & Certification</a></h4>
            <p class="description">Get professional career advice and earn a certification to boost your graphic design career opportunities.</p>
          </div>
        </div>
      </div>
    </div>
...
<section id="upcoming-classes" class="upcoming-classes section mb-5">
  <div class="container">
    <div class="content-box">
      ...
      <p>🎨 Ready to explore the world of graphic design? Join our **FREE Graphic Design Demo Class** and get hands-on experience with Photoshop & Illustrator! 🚀 Learn from expert designers, work on real projects, and kickstart your creative journey. Don't miss out—secure your spot today! 🌟</p>
      <p><strong>Date:</strong> February 20, 2025 <strong>Time:</strong> 4:00 PM</p>
      <p><strong>Location:</strong> Online via Google Meet</p>
      <div class="countdown">
...
<!-- <section id="demo-video" class="demo-video section mb-5">
  <div class="container">
    <div class="content-box">
      <h2 class="text-center">Watch Our Graphic Design Demo</h2>
      <p class="text-center">Get a sneak peek into our Graphic Design Demo Class and learn the fundamentals of Photoshop & Illustrator.</p>
      <div class="video-wrapper">
        <iframe class="responsive-video" src="https://www.youtube.com/embed/YOUR_VIDEO_ID" 
          title="Graphic Design Demo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
        </iframe>
      </div>
    </div>
  </div>
...
<!-- <section id="upcoming-masterclasses" class="upcoming-masterclasses section">
    <div class="container">
        <h2 class="mb-5">Upcoming Graphic Design Masterclasses</h2>
        <div class="row"> -->
            <!-- Masterclass Card 1 -->
            <!-- <div class="col-md-4">
                <div class="masterclass-card">
                    ...
                    <p>Time: 10:00 AM</p>
                    <p>Google Meet</p>
                    <button onclick="enrollMasterclass('March 10, 2025 10:00:00')">Enroll Now</button>
                </div>
            </div> -->
            <!-- Masterclass Card 2 -->
            <!-- <div class="col-md-4">
                <div class="masterclass-card">
                    ...
                    <p>Date: March 17, 2025</p>
                    <p>Time: 10:00 AM</p>
                    <p>Google Meet</p>
                    <button onclick="enrollMasterclass('March 17, 2025 10:00:00')">Enroll Now</button>
                </div>
            </div> -->
            <!-- Masterclass Card 3 -->
            <!-- <div class="col-md-4">
                <div class="masterclass-card">
                    ...
                    <p>Time: 10:00 AM</p>
                    <p>Google Meet</p>
                    <button onclick="enrollMasterclass('March 24, 2025 10:00:00')">Enroll Now</button>
                </div>
            </div>
        </div>
    </div>
...
<section id="features-details" class="features-details section mb-5">
  <div class="container">
    <!-- First Feature: Adobe Photoshop Basics -->
    <div class="row gy-4 justify-content-between features-item">
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <img src="images/graphic-design/photoshop-basics.png" class="img-fluid rounded" alt="Photoshop Basics">
      </div>
      <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
        <div class="content">
          <h3 class="text-uppercase">Adobe Photoshop Basics</h3>
          <ul class="subtopics">
            <li><i class="bi bi-palette"></i> Understanding the Photoshop Interface and Tools.</li>
            <li><i class="bi bi-image"></i> Image Editing and Retouching Techniques.</li>
            <li><i class="bi bi-layers"></i> Working with Layers, Masks, and Blending Modes.</li>
            <li><i class="bi bi-brush"></i> Basic Typography and Text Effects.</li>
          </ul>
        </div>
      </div>
    </div><!-- Features Item -->

    <!-- Second Feature: Illustrator Essentials -->
    <div class="row gy-4 justify-content-between features-item">
      <div class="col-lg-6 d-flex align-items-center order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
        <div class="content">
          <h3 class="text-uppercase">Illustrator Essentials</h3>
          <ul class="subtopics">
            <li><i class="bi bi-vector-pen"></i> Mastering the Pen Tool and Vector Illustration.</li>
            <li><i class="bi bi-grid"></i> Creating Logos, Icons, and Scalable Graphics.</li>
            <li><i class="bi bi-brush"></i> Using Gradients, Brushes, and Effects for Design.</li>
          </ul>
        </div>
      </div>
      <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
        <img src="images/graphic-design/illustrator.png" class="img-fluid rounded" alt="Illustrator Essentials">
      </div>
    </div><!-- Features Item -->

    <!-- Third Feature: Advanced Graphic Design -->
    <div class="row gy-4 justify-content-between features-item">
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <img src="images/graphic-design/advanced-design.png" class="img-fluid rounded" alt="Advanced Graphic Design">
      </div>
      <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
        <div class="content">
          <h3 class="text-uppercase">Advanced Graphic Design</h3>
          <ul class="subtopics">
            <li><i class="bi bi-layout-text-window"></i> Layout Design for Print and Digital Media.</li>
            <li><i class="bi bi-megaphone"></i> Social Media Graphics and Branding.</li>
            <li><i class="bi bi-film"></i> Motion Graphics Basics using After Effects.</li>
          </ul>
        </div>
      </div>
    </div><!-- Features Item -->
...
<section id="placement-program" class="placement-program section mb-5">
  <div class="container">
    <h2 class="text-center section-title"><span>Weekend</span> Graphic Design Masterclass:</h2>
    <div class="row mt-4">
      <div class="col-md-6">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="leftHeadingOne">
              <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#leftCollapseOne" aria-expanded="true" aria-controls="leftCollapseOne">
                Design Fundamentals (Weekends 1-2)
              </button>
            </h2>
            <div id="leftCollapseOne" class="accordion-collapse collapse show" aria-labelledby="leftHeadingOne" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  <li>Saturday & Sunday: Introduction to Graphic Design, Color Theory, Typography, and Composition.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="leftHeadingTwo">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#leftCollapseTwo" aria-expanded="false" aria-controls="leftCollapseTwo">
                Adobe Photoshop Mastery (Weekends 3-4)
              </button>
            </h2>
            <div id="leftCollapseTwo" class="accordion-collapse collapse" aria-labelledby="leftHeadingTwo" data-bs-parent="#programLeft">
              <div class="accordion-body">
                <ul>
                  <li>Saturday & Sunday: Photo Editing, Retouching, Layering, and Creating Stunning Visual Effects.</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div class="col-md-6">
        <div class="accordion" id="programRight">
          <!-- Branding and Social Media Design -->
          <div class="accordion-item">
            <h2 class="accordion-header" id="rightHeadingOne">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rightCollapseOne" aria-expanded="false" aria-controls="rightCollapseOne">
                Branding & Social Media Design (Weekends 7-8)
              </button>
            </h2>
            <div id="rightCollapseOne" class="accordion-collapse collapse" aria-labelledby="rightHeadingOne" data-bs-parent="#programRight">
              <div class="accordion-body">
                <ul>
                  <li>Saturday & Sunday: Creating Social Media Graphics, Ad Banners, and Brand Identity.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="rightHeadingTwo">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rightCollapseTwo" aria-expanded="false" aria-controls="rightCollapseTwo">
                Final Project & Portfolio Development (Weekends 9-10)
              </button>
            </h2>
            <div id="rightCollapseTwo" class="accordion-collapse collapse" aria-labelledby="rightHeadingTwo" data-bs-parent="#programRight">
              <div class="accordion-body">
                <ul>
                  <li>Saturday & Sunday: Hands-on project, portfolio creation, and preparation for design job interviews.</li>
                </ul>
              </div>
            </div>
          </div>
...
<script>
  function sendEmail() {
    ...
    let params = {
        ...
        name: document.getElementById('name').value,Upcoming Graphic Design Bootcamps
...
<section id="enroll" class="enroll section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h2>Join the Graphic Design Masterclass: Start Your Creative Journey Today!</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" id="course" name="course" required>
                                <option selected>Graphic Design Masterclass</option>
            ...
            <div class="col-lg-6 text-center">
                <img src="images/graphic-design/enroll.png" alt="Enroll Image" class="img-fluid animated">
            </div>
        </div>
    </div>
</section>
...
<section id="faq" class="faq section-bg mt-5">
  <div class="container" data-aos="fade-up">
    ...
    <header class="section-header">
      <h3>FAQ</h3>
      <p>Find answers to common questions about Urbancode's Graphic Design Masterclass.</p>
    </header>
    ...
    <div class="faq-list">
      <ul>
        <li data-aos="fade-up" data-aos-delay="100">
          ...
          <a href="#" data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">What is the Graphic Design Masterclass at Urbancode?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
            <p>
              The Graphic Design Masterclass at Urbancode is an intensive training program designed to equip participants with essential design skills using industry-standard tools like Adobe Photoshop, Illustrator, and Figma. The course covers design principles, branding, UI/UX, and real-world projects.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="200">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">What does the Graphic Design Masterclass include?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
            <p>
              The course includes hands-on training in graphic design fundamentals, typography, color theory, branding, and digital marketing designs. Participants will work on real-world projects to build a professional portfolio.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="300">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Who should attend the Graphic Design Masterclass?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
            <p>
              This masterclass is perfect for beginners, aspiring graphic designers, marketing professionals, entrepreneurs, and anyone looking to enhance their visual communication skills.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="400">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">What software will I learn in this course?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
            <p>
              You will gain expertise in Adobe Photoshop, Illustrator, InDesign, and Figma, which are widely used in the design industry for creating logos, social media graphics, web designs, and branding materials.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="500">
          <i class="bi bi-question-circle icon-question"></i>
          <a href="#" data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">How can I enroll in the Graphic Design Masterclass?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
            <p>
              You can enroll in the Graphic Design Masterclass by visiting the Urbancode website, navigating to the masterclass section, and completing the registration process. Early registration is recommended as seats are limited.
            </p>
          </div>
        </li>
      </ul>
